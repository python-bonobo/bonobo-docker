...
setup(
    ...
    install_requires=['bonobo (>= 0.5.1, < 0.6)', 'docker (>= 2.3, < 2.4)', 'requests (>= 2.16, < 3.0)'],
    extras_require={
        'dev': [
            'bonobo (>= 0.5.1, < 0.6)', 'coverage (>= 4.4, < 5.0)', 'pytest (>= 3.1, < 4.0)',
            'pytest-cov (>= 2.5, < 3.0)', 'sphinx (>= 1.6, < 2.0)', 'yapf'
        ]
    },
